      ...
      <div className="card">
        ...
        <div className="flex flex-col sm:flex-row gap-3 mt-5">
          <button 
            ...
            className="flex-1 flex items-center justify-center gap-2 py-2.5 px-4 rounded-xl bg-bg-hover border border-border text-sm font-medium text-text-secondary hover:text-text-primary hover:border-border-light transition-all cursor-pointer"
          >
